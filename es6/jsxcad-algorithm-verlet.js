...
const relax$1 = (
  { pivot, left, right, radians, stiffness },
  stepCoefficient
) => {
...
export {
  force as addGravity,
  force$1 as addInertia,
  create as createAngleConstraint,
  create$1 as createDistanceConstraint,
  create$2 as createPinnedConstraint,
  positions,
  solve,
  verlet,
};
