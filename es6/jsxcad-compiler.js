...
var object_hash = createCommonjsModule(function (module, exports) {
  !(function (e) {
    ...
    return (function o(i, u, a) {
      ...
      for (
        var f = "function" == typeof commonjsRequire && commonjsRequire, e = 0;
        e < a.length;
        e++
      )
        s(a[e]);
          ...
          function (w, b, m) {
            (function (e, t, f, n, r, o, i, u, a) {
              ...
              ((m = b.exports = c).sha1 = function (e) {
                ...
                (m.MD5 = function (e) {
                  return c(e, { algorithm: "md5", encoding: "hex" });
                }),
              ...
              function h(e, t) {
                ...
                for (var r = 0; r < l.length; ++r)
                  l[r].toLowerCase() === n.algorithm.toLowerCase() &&
                    (n.algorithm = l[r]);
                if (-1 === l.indexOf(n.algorithm))
                  throw new Error(
                    'Algorithm "' +
                      n.algorithm +
              ...
              function g(u, t, a) {
                ...
                return {
                  ...
                  _object: function (t) {
                    ...
                    if (
                      (a.push(t), void 0 !== f && f.isBuffer && f.isBuffer(t))
                    )
                      return s("buffer:"), s(t);
                    if (
                      "object" === n ||
                  ...
                  return (
                    2 == o
                      ? s(
                          255 &
                            (r =
                              (c(e.charAt(t)) << 2) | (c(e.charAt(t + 1)) >> 4))
                        )
                      : 1 == o &&
                        (s(
                          ((r =
            ...
            (function (e, t, h, n, r, o, i, u, a) {
              ...
              function h(e, t, n) {
                ...
                if ("base64" === t && "string" == s)
                  for (
                    ...
                    e += "=";
                if ("number" == s) o = x(e);
                else if ("string" == s) o = h.byteLength(e, t);
                else {
                  if ("object" != s)
                    throw new Error(
                ...
                if (
                  (h._useTypedArrays
                    ? (i = h._augment(new Uint8Array(o)))
                    : (((i = this).length = o), (i._isBuffer = !0)),
                  h._useTypedArrays && "number" == typeof e.byteLength)
                )
                  i._set(e);
                else if (
                  S((a = e)) ||
                ...
                else if ("number" == s && !h._useTypedArrays && !n)
                  for (u = 0; u < o; u++) i[u] = 0;
                return i;
              }
              function p(e, t, n, r) {
                return (h._charsWritten = T(
                  (function (e) {
              ...
              function I(e, t, n, r, o) {
                o ||
                  ...
                  e.length <= n ||
                    _(e, 0 <= t ? t : 4294967295 + t + 1, n, r, o);
              }
              ...
              (H.Buffer = h),
                ...
                (h.prototype.slice = function (e, t) {
                  var n = this.length;
                  if (((e = U(e, n, 0)), (t = U(t, n, n)), h._useTypedArrays))
                    return h._augment(this.subarray(e, t));
                  for (
                    var r = t - e, o = new h(r, void 0, !0), i = 0;
                    i < r;
                    i++
                  )
                    o[i] = this[i + e];
                      ...
                      A < 16
                        ...
                        : B(
                            B(
                              B(
                                ((m = E[A - 2]),
                                L(m, 17) ^ L(m, 19) ^ U(m, 10)),
                                E[A - 7]
                              ),
                              ((b = E[A - 15]), L(b, 7) ^ L(b, 18) ^ U(b, 3))
                            ),
                            E[A - 16]
                          )),
                      (c = B(
