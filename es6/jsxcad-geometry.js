...
const eachPoint = op(
  { graph: eachPoint$1, paths: paths$3, points: points$1, polygonsWithHoles: polygonsWithHoles$3, segments: segments$4 },
  visit
);
