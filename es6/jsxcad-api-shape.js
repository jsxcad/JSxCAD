...
const scaleToFit = Shape.registerMethod3(
  ...
  ['inputGeometry', 'coordinate', 'number', 'number', 'number'],
  (input, coordinate, dX = 1, dY = dX, dZ = dY) =>
    scaleToFit$1(input, coordinate || [dX, dY, dZ])
);
