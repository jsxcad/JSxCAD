...
export const main = () => {
  ...
  writeStl({ path: 'tmp/assembly-cube.stl' }, assembly.toPaths({ tags: ['cube'] }));

  // This should produce the cube with a hole in it filled by the cylinder.
  writeStl({ path: 'tmp/assembly-cube-cylinder.stl' }, assembly.toPaths({ tags: ['cube', 'cylinder'] }));

  // This should produce just the cylinder and no cube.
  writeStl({ path: 'tmp/assembly-cylinder.stl' }, assembly.toPaths({ tags: ['cylinder'] }));
