...
test('Bridge', t => {
  ...
  t.deepEqual(canonicalize(convexSurface),
              [[[-2.5, -2.5, 0], [-5, 5, 0], [-5, -5, 0]], [[-5, 5, 0], [-2.5, -2.5, 0], [-2.5, 2.5, 0]], [[2.5, -2.5, 0], [-2.5, -2.5, 0], [-5, -5, 0]], [[5, 5, 0], [-5, 5, 0], [-2.5, 2.5, 0]], [[2.5, -2.5, 0], [-5, -5, 0], [5, -5, 0]], [[5, 5, 0], [-2.5, 2.5, 0], [2.5, 2.5, 0]], [[2.5, 2.5, 0], [2.5, -2.5, 0], [5, -5, 0]], [[5, -5, 0], [5, 5, 0], [2.5, 2.5, 0]]]);
});
