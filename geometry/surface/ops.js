import { canonicalize as canonicalizePolygon, transform as transformPolygon } from '@jsxcad/math-poly3';
...
export const translate = (vector, surface) => transform(fromTranslation(vector), surface);
