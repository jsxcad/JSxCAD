...
export const rotateX = (radians, solid) => transform(fromXRotation(radians), solid);
export const rotateY = (radians, solid) => transform(fromYRotation(radians), solid);
export const rotateZ = (radians, solid) => transform(fromZRotation(radians), solid);
