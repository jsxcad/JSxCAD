import { mergeLoops } from './merge.js';
...
test('Box', (t) => {
  ...
  t.deepEqual(graph, {
    ...
    edges: [
      { point: 0, loop: 0, twin: 12, next: 1 },
      { point: 1, loop: 0, twin: 7, next: 2 },
      { point: 2, loop: 0, twin: 5, next: 5 },
      { point: 2, loop: 0, twin: 24, next: 4 },
      { point: 3, loop: 0, twin: 18, next: 0 },
      { point: 0, loop: 0, twin: 2, next: 3 },
      { point: 4, loop: 2, twin: 25, next: 7 },
      { point: 2, loop: 2, twin: 1, next: 8 },
      { point: 1, loop: 2, twin: 11, next: 11 },
      { point: 1, loop: 2, twin: 16, next: 10 },
      { point: 5, loop: 2, twin: 34, next: 6 },
      { point: 4, loop: 2, twin: 8, next: 9 },
      { point: 1, loop: 4, twin: 0, next: 13 },
      { point: 0, loop: 4, twin: 22, next: 14 },
      { point: 6, loop: 4, twin: 17, next: 17 },
      { point: 6, loop: 4, twin: 30, next: 16 },
      { point: 5, loop: 4, twin: 9, next: 12 },
      { point: 1, loop: 4, twin: 14, next: 15 },
      { point: 0, loop: 6, twin: 4, next: 19 },
      { point: 3, loop: 6, twin: 28, next: 20 },
      { point: 7, loop: 6, twin: 23, next: 23 },
      { point: 7, loop: 6, twin: 31, next: 22 },
      { point: 6, loop: 6, twin: 13, next: 18 },
      { point: 0, loop: 6, twin: 20, next: 21 },
      { point: 3, loop: 8, twin: 3, next: 25 },
      { point: 2, loop: 8, twin: 6, next: 26 },
      { point: 4, loop: 8, twin: 29, next: 29 },
      { point: 4, loop: 8, twin: 33, next: 28 },
      { point: 7, loop: 8, twin: 19, next: 24 },
      { point: 3, loop: 8, twin: 26, next: 27 },
      { point: 5, loop: 10, twin: 15, next: 31 },
      { point: 6, loop: 10, twin: 21, next: 32 },
      { point: 7, loop: 10, twin: 35, next: 35 },
      { point: 7, loop: 10, twin: 27, next: 34 },
      { point: 4, loop: 10, twin: 10, next: 30 },
      { point: 5, loop: 10, twin: 32, next: 33 },
    ],
    loops: [
      { edge: 2, face: 0 },
      { edge: -1, face: 1 },
