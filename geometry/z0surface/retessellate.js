...
export const retessellate = (sourcePolygons) => {
  ...
  let { yCoordinates, yCoordinateToPolygons, yCoordinateToPolygonIndexes, topYToPolygonIndexes, normalizedPolygons, polygonTopVertexIndexes } = binPolygons(sourcePolygons);
  ...
  for (let yIndex = 0; yIndex < yCoordinates.length; yIndex++) {
    ...
    const polygonsWithCorner = yCoordinateToPolygons.get(yCoordinate);
