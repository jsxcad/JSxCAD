...
test('all together', (t) => {
  ...
  t.deepEqual(r, [[[5, -5, 0], [8, 0, 0], [5, 5, 0], [0, 8, 0], [-5, 5, 0], [-8, 0, 0], [-5, -5, 0], [0, -8, 0]]]);
});

test('left and right', (t) => {
  const r = retessellate([right, left]);
  t.deepEqual(r, [[[-5, 5, 0], [-8, 0, 0], [-5, -5, 0]], [[8, 0, 0], [5, 5, 0], [5, -5, 0]]]);
});

test('top and right', (t) => {
  const r = retessellate([top, left]);
  t.deepEqual(r, [[[-5, 5, 0], [-8, 0, 0], [-5, -5, 0]], [[5, 5, 0], [0, 8, 0], [-5, 5, 0]]]);
});
...
test('overlapping', t => {
  ...
  t.deepEqual(r, [[[10, -5, 0], [10, 5, 0], [0, 5, 0], [0, -5, 0]], [[10, -5, 0], [10, 5, 0], [0, 5, 0], [0, -5, 0]]]);
});
