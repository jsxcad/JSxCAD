...
test('Simple', t => {
  ...
  t.deepEqual(canonicalize(disjoint),
              { 'disjointAssembly': [{ 'disjointAssembly': [{ 'surface': [[[-0.28868, 0.5, 0], [-0.28868, 0.5, 0], [-0.5, 0.13398, 0], [-0.5, 0.13398, 0]], [[0.5, 0.13399, 0], [0.36603, 0.36603, 0], [0.5, 0.28868, 0], [0.5, 0.5, 0], [0.28868, 0.5, 0], [0.5, 0.13398, 0]]], 'tags': ['a'] }] }, { 'disjointAssembly': [{ 'surface': [[[-0.18301, 0.68302, 0], [-0.5, 0.86603, 0], [-0.5, 0.13398, 0]], [[1, 0, 0], [0.36603, 0.36603, 0], [0.68302, -0.18301, 0]], [[0.13398, -0.5, 0], [-0.5, -0.5, 0], [-0.5, -0.86603, 0]]], 'tags': ['b'] }] }, { 'disjointAssembly': [{ 'surface': [[[0, 1, 0], [-0.86603, -0.5, 0], [0.86603, -0.5, 0]]], 'tags': ['c'] }] }] });
});
