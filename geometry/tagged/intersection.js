...
const intersectionImpl = (geometry, ...geometries) => {
  const op = (geometry, descend) => {
    if (geometry.solid) {
      ...
      return { solid: solidIntersection(geometry.solid, ...todo), tags: geometry.tags };
      ...
      return { surface: surfaceIntersection(geometry.surface, ...todo), tags: geometry.tags };
      ...
      if (todoSurfaces.length > 0) {
        return { surface: surfaceIntersection(geometry.z0Surface, ...todoSurfaces, ...todoZ0Surfaces), tags: geometry.tags };
      } else {
        return { surface: z0SurfaceIntersection(geometry.z0Surface, ...todoZ0Surfaces), tags: geometry.tags };
      }
      ...
      return { paths: pathsIntersection(geometry.paths, ...todo), tags: geometry.tags };
    } else {
      return descend();
    }
  };
