...
test('Surface', t => {
  ...
  t.deepEqual(canonicalize(solid),
              { 'assembly': [{ 'surface': [[[0.5, -0.4, 0], [0.69282, -0.4, 0], [0.5, -0.06603, 0], [0.5, 0.5, 0], [0.17321, 0.5, 0], [0, 0.8, 0], [-0.17321, 0.5, 0], [-0.5, 0.5, 0], [-0.5, -0.06603, 0], [-0.69282, -0.4, 0], [-0.5, -0.4, 0], [-0.5, -0.5, 0], [0.5, -0.5, 0]]] }] });
});
