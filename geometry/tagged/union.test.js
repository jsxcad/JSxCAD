...
test('Surface', t => {
  ...
  t.deepEqual(canonicalize(surface),
              { 'disjointAssembly': [{ 'surface': [[[0.5, -0.4, 0], [0.69282, -0.4, 0], [0.5, -0.06602, 0], [0.5, 0.5, 0], [0.17321, 0.5, 0], [0, 0.8, 0], [-0.17321, 0.5, 0], [-0.5, 0.5, 0], [-0.5, -0.06602, 0], [-0.69282, -0.4, 0], [-0.5, -0.4, 0], [-0.5, -0.5, 0], [0.5, -0.5, 0]]] }] });
});
