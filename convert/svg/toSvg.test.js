...
test('Triangle', async t => {
  const svg = await toSvg({ padding: 2 },
                          { disjointAssembly: [{ z0Surface: [buildRegularPolygon(3)], tags: ['color/blue'] },
                                               { paths: [buildRegularPolygon(3)], tags: ['color/red'] }] });
  t.is(svg,
...
test('Octagon', async t => {
  const svg = await toSvg({}, { surface: [buildRegularPolygon(8)] });
  t.is(svg,
       `<?xml version="1.0" encoding="UTF-8"?>
<!-- Generated by jsxcad -->
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1 Tiny//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11-tiny.dtd">
