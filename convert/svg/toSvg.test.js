...
test('Triangle', async t => {
  const svg = await toSvg({ padding: 2 },
                          { disjointAssembly: [{ z0Surface: buildRegularPolygon(3).z0Surface, tags: ['color/blue'] },
...
<path fill="blue" d="M1.75 0.86603 L0.25 1.73205 L0.25 0 z"/>
<path stroke="red" d="M1.75 0.86603 L0.25 1.73205 L0.25 0 z"/>
</svg>`);
});
...
<path fill="black" d="M0.29289 0.29289 L1 0 L1.70711 0.29289 z"/>
<path fill="black" d="M1.70711 0.29289 L2 1 L1.70711 1.70711 z"/>
<path fill="black" d="M1.70711 1.70711 L1 2 L0.29289 1.70711 z"/>
<path fill="black" d="M0.29289 1.70711 L0 1 L0.29289 0.29289 z"/>
<path fill="black" d="M0.29289 0.29289 L1.70711 0.29289 L1.70711 1.70711 z"/>
<path fill="black" d="M1.70711 1.70711 L0.29289 1.70711 L0.29289 0.29289 z"/>
</svg>`);
});
