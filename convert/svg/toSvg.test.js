...
test('Triangle', async t => {
  const svg = await toSvg({ disjointAssembly: [{ z0Surface: buildRegularPolygon(3).z0Surface, tags: ['color/blue'] },
...
<path fill="black" d="M2 1 L1.70711 1.70711 L1 2 z"/>
<path fill="black" d="M2 1 L1 2 L0.29289 1.70711 z"/>
<path fill="black" d="M2 1 L0.29289 1.70711 L0 1 z"/>
<path fill="black" d="M2 1 L0 1 L0.29289 0.29289 z"/>
<path fill="black" d="M2 1 L0.29289 0.29289 L1 0 z"/>
<path fill="black" d="M2 1 L1 0 L1.70711 0.29289 z"/>
</svg>`);
});
