...
export const toThreejsPage = async ({ cameraPosition = [0, 0, 16], title = 'JSxCAD Viewer', includeEditor = false, includeEvaluator = false, initialScript = '', initialPage = 'editor', previewPage = 'default' }, geometry) => {
  ...
  const body = [
    ...
    `<!-- FileSaver -->`,
    `<script type="module">`,
    `import { api, sys, toThreejsGeometry } from 'https://unpkg.com/@jsxcad/api-v1-bundle@^0.0.70/dist/main?module';`,
    ...
    `import { display } from 'https://unpkg.com/@jsxcad/convert-threejs@^0.0.70/display.js?module';`,
    ...
    includeEditor ? `import { editor } from 'https://unpkg.com/@jsxcad/convert-threejs@^0.0.70/editor.js?module'` : '',
