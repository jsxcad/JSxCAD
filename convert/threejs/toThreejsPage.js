...
export const toThreejsPage = async ({ cameraPosition = [0, 0, 16], title = 'JSxCAD Viewer', includeEditor = false, includeEvaluator = false, initialScript = '', initialPage = 'editor', previewPage = 'default' }, geometry) => {
  ...
  const body = [
    ...
    includeEvaluator ? `import * as api from 'https://unpkg.com/@jsxcad/api-v1-bundle@0.0.61?module';` : 'const api = {};',
    `import { readFile, watchFile, watchFileCreation, writeFile } from 'https://unpkg.com/@jsxcad/sys@0.0.61?module';`,
    includeEvaluator ? `import { toThreejsGeometry } from 'https://unpkg.com/@jsxcad/convert-threejs@0.0.61?module';` : 'const toThreejsGeometry = g => g;',
