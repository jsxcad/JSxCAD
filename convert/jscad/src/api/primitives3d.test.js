...
test("cube (standard size, rounded)", (t) => {
  ...
  const expFirstPoly = {
    vertices: [
      { pos: { _x: 0.09999999999999998, _y: 0, _z: 0.09999999999999998 } },
      {
        pos: {
  ...
  const expPoly5 = {
    vertices: [
      { pos: { _x: 0.8999999999999998, _y: 0.09999999999999998, _z: 0 } },
      {
        pos: {
  ...
  t.deepEqual(obs.properties.sphere.center, {
    _x: 0.09999999999999998,
    _y: 0.09999999999999998,
    _z: 0.09999999999999998,
  });
  t.deepEqual(obs.properties.roundedCube.center, {
    pos: { _x: 0.5, _y: 0.5, _z: 0.5 },
  });
...
test("cube (custom size, rounded)", (t) => {
  ...
  const expFirstPoly = {
    vertices: [
      { pos: { _x: 0.5, _y: 0, _z: 0.5 } },
      { pos: { _x: 0.14644660940672338, _y: 0.14644660940672694, _z: 0.5 } },
      { pos: { _x: 0.25, _y: 0.25, _z: 0.14644660940672627 } },
      { pos: { _x: 0.5, _y: 0.14644660940672694, _z: 0.14644660940672627 } },
    ],
    shared: { color: null, tag: 296 },
    plane: {
      normal: {
...
test("sphere (defaults)", (t) => {
  ...
  const expFirstPoly = {
    vertices: [
      ...
      {
        pos: {
          _x: 0.9619397662556434,
          _y: -0.19134171618254486,
          _z: -0.19509032201612825,
        },
      },
    ...
    plane: {
      normal: {
        _x: 0.9904383506609418,
        _y: -0.09754966309535142,
        _z: -0.09754966309535128,
      },
  ...
  const expPoly511 = {
    vertices: [
      ...
      {
        pos: {
          _x: 0.19509032201612833,
          _y: 4.778334768033559e-17,
          _z: 0.9807852804032304,
        },
      },
      {
        pos: {
          _x: 0.19134171618254492,
          _y: 0.03806023374435672,
          _z: 0.9807852804032304,
        },
      },
    ],
    ...
    plane: {
      normal: {
        _x: 0.09801257320997024,
        _y: 0.009653395882096847,
        _z: 0.9951383559288144,
      },
...
test("sphere (geodesic)", (t) => {
  ...
  const expFirstPoly = {
    vertices: [
      ...
      {
        pos: {
          _x: 0.8659842041673648,
          _y: -0.1875222783339947,
    ...
    plane: {
      normal: {
        _x: 0.8962330678097445,
        _y: -0.07179554325990238,
        _z: -0.4377347234711329,
      },
  ...
  const expPoly499 = {
    vertices: [
      ...
      {
        pos: {
          _x: 0.11589509083138601,
          _y: -0.6511026416595388,
          _z: -0.7500891133359788,
        },
      },
      {
        pos: {
...
test("sphere (custom radius , resolution, center)", (t) => {
  ...
  const expPoly59 = {
    vertices: [
      { pos: { _x: 9.907600726170914e-17, _y: 7.19829327805997e-17, _z: 4 } },
      {
        pos: {
          _x: 1.0000000000000002,
          _y: 2.449293598294707e-16,
          _z: 3.732050807568877,
        },
      },
      {
        pos: {
          _x: 0.8090169943749475,
          _y: 0.5877852522924735,
          _z: 3.732050807568877,
        },
      },
    ],
...
test("cylinder (defaults)", (t) => {
  ...
  t.deepEqual(obs.properties.cylinder.start, {
    point: { _x: 0, _y: 0, _z: 0 },
    axisvector: { _x: -0, _y: -0, _z: -1 },
    normalvector: { _x: 1, _y: 0, _z: 0 },
  });
  t.deepEqual(obs.properties.cylinder.end, {
    point: { _x: 0, _y: 0, _z: 1 },
    axisvector: { _x: 0, _y: 0, _z: 1 },
    normalvector: { _x: 1, _y: 0, _z: 0 },
  });
...
test("cylinder (custom double radius, rounded)", (t) => {
  ...
  const expFirstPoly = {
    vertices: [
      { pos: { _x: 0.19509032201612825, _y: 0.9807852804032304, _z: 0 } },
      { pos: { _x: 0, _y: 1, _z: 0 } },
      { pos: { _x: 0, _y: 1, _z: 1 } },
  ...
  const expPoly543 = {
    vertices: [
      {
        pos: { _x: -1.1945836920083923e-17, _y: 6.005577771483276e-17, _z: 2 },
      },
      {
        pos: {
          _x: -4.778334768033559e-17,
          _y: 0.19509032201612833,
          _z: 1.9807852804032304,
        },
      },
      {
        pos: {
          _x: -0.03806023374435672,
          _y: 0.19134171618254492,
          _z: 1.9807852804032304,
        },
      },
    ],
    ...
    plane: {
      normal: {
        _x: -0.009653395882096847,
        _y: 0.09801257320997024,
        _z: 0.9951383559288144,
      },
  ...
  t.deepEqual(obs.properties.roundedCylinder.start, {
    point: { _x: 0, _y: 0, _z: 0 },
    axisvector: { _x: -0, _y: -0, _z: -1 },
    normalvector: { _x: 0, _y: 1, _z: 0 },
  });
  t.deepEqual(obs.properties.roundedCylinder.end, {
    point: { _x: 0, _y: 0, _z: 1 },
    axisvector: { _x: 0, _y: 0, _z: 1 },
    normalvector: { _x: 0, _y: 1, _z: 0 },
  });
...
test("cylinder (custom double diameter, rounded, start, end)", (t) => {
  ...
  const expPoly543 = {
    vertices: [
      {
        pos: { _x: -1.1945836920083923e-17, _y: 6.005577771483276e-17, _z: 11 },
      },
      {
        pos: {
          _x: -4.778334768033559e-17,
          _y: 0.19509032201612833,
          _z: 10.98078528040323,
        },
      },
      {
        pos: {
...
test("torus (defaults)", (t) => {
  ...
  const expFirstPoly = {
    positions: [
      ...
      [4.829268567965809, -0.96060124356625, -0.3826834323650906],
    ],
    plane: {
  ...
  const expLastPoly = {
    positions: [
      [4.82926856796581, 0.9606012435662523, -0.3826834323650903],
      [4.923879532511286, 5.551115123125783e-17, -0.3826834323650904],
      [4.707106781186546, 0, -0.7071067811865475],
      [4.616661044273995, 0.9183109777059867, -0.7071067811865483],
    ],
    plane: {
  ...
  t.deepEqual(
    simplifiedPolygon(obs.polygons[obs.polygons.length - 1]),
    expLastPoly
  );
});
...
test("torus (custom all)", (t) => {
  ...
  const expFirstPoly = {
    positions: [
      ...
      [5.035533905932736, -5.035533905932738, 2.1213203435596424],
      [5.035533905932736, -5.035533905932738, -2.1213203435596433],
      [7.121320343559641, 0, -2.1213203435596433],
    ],
    plane: {
      normal: [
        0.9238795325112867,
  ...
  const expLastPoly = {
    positions: [
      [2.0355339059327378, -2.035533905932737, -2.121320343559643],
      [2.878679656440357, 2.220446049250313e-16, -2.121320343559643],
      [2.8786796564403567, -5.9289321881345245, -2.121320343559643],
      [2.0355339059327373, -6.2781745930520225, -2.1213203435596424],
    ],
    plane: {
      normal: [-3.14018491736755e-16, 1.300707181133076e-16, -1],
      w: 2.121320343559641,
    },
    shared: { color: null, tag: 296 },
  };
