...
test("translate (single item , 2d)", (t) => {
  ...
  t.deepEqual(obs.sides[0], {
    vertex0: { pos: { _x: 0, _y: 11 } },
    vertex1: { pos: { _x: 0, _y: 10 } },
  });
  t.deepEqual(obs.sides[obs.sides.length - 1], {
    vertex0: { pos: { _x: 1, _y: 11 } },
    vertex1: { pos: { _x: 0, _y: 11 } },
  });
});
...
test("translate (multiple items, 2d)", (t) => {
  ...
  sideEquals(t, obs.sides[0], [
    [1.9807852804032304, 10.804909677983872],
    [2, 11],
  ]);
  sideEquals(t, obs.sides[obs.sides.length - 1], [
    [0, 10],
...
test("rotate (single item)", (t) => {
  ...
  t.deepEqual(obs.properties.cube.center, {
    _x: 0.5266504075063266,
    _y: 0.5,
    _z: 0.47184674235753715,
  });
});
...
test("rotate (multiple items)", (t) => {
  ...
  t.deepEqual(obs.properties.sphere.center, {
    _x: 1.0533008150126533,
    _y: 1,
    _z: 0.9436934847150743,
  });
});
...
test("rotate (multiple items, 2d)", (t) => {
  ...
  sideEquals(t, obs.sides[0], [
    [1.9506927011935618, 0.8049096779838713],
    [1.969615506024416, 1],
  ]);
  sideEquals(t, obs.sides[obs.sides.length - 1], [
    [0, 0],
    [0.9848077530122078, 0],
  ]);
});
...
test("transform (multiple items, 2d , translation)", (t) => {
  ...
  sideEquals(t, obs.sides[0], [
    [11.98078528040323, -4.195090322016129],
    [12, -4],
  ]);
  sideEquals(t, obs.sides[obs.sides.length - 1], [
    [10, -5],
...
test("center (multiple items, 2d)", (t) => {
  ...
  sideEquals(t, obs.sides[0], [
    [0.9807852804032304, -0.19509032201612875],
    [1, 0],
  ]);
  sideEquals(t, obs.sides[obs.sides.length - 1], [
    [-1, -1],
...
test("mirror (single item)", (t) => {
  ...
  t.deepEqual(obs.properties.cube.center, {
    _x: 0.36046511627906974,
    _y: 0.2209302325581396,
    _z: -0.7558139534883721,
  });
});
...
test("expand (single item)", (t) => {
  ...
  t.deepEqual(obs.polygons[0].vertices[0], {
    pos: { _x: -10, _y: 0, _z: 0 },
    tag: 25969,
  });
});
...
test("expand (multiple items, 2d)", (t) => {
  ...
  t.deepEqual(obs.sides[0], {
    vertex0: { pos: { _x: 11, _y: 0 } },
    vertex1: { pos: { _x: 11, _y: 1 } },
  });
  t.deepEqual(obs.sides[obs.sides.length - 1], {
    vertex0: { pos: { _x: -1.8369701987210296e-15, _y: -10 } },
    vertex1: { pos: { _x: 0.9999999999999981, _y: -10 } },
  });
});
...
test("hull (multiple items, 2d)", (t) => {
  ...
  t.deepEqual(obs.sides[0], {
    vertex0: { pos: { _x: 0, _y: 1.0000000000000002 } },
    vertex1: { pos: { _x: 0, _y: 0 } },
  });
  t.deepEqual(obs.sides[obs.sides.length - 1], {
    vertex0: { pos: { _x: 0.01921471959676957, _y: 1.1950903220161286 } },
    vertex1: { pos: { _x: 0, _y: 1.0000000000000002 } },
  });
});
