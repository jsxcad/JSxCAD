...
export const toHtmlFromNotebook = async (
  notebook,
  {
    view,
    title = 'JSxCAD Viewer',
...
export const toHtmlFromScript = async ({
  view,
  title = 'JSxCAD Viewer',
  modulePath = 'https://jsxcad.js.org/alpha',
...
export const toStandaloneFromScript = async ({
  view,
  title = 'Jot',
  modulePath = 'https://jsxcad.js.org/alpha',
  baseUrl = 'https://jsxcad.js.org',
...
<html>
 ...
 <body>
  ...
  <script type='module'>
    ...
    run({ encodedFiles: ${JSON.stringify(
      encodedFiles
    )}, module: "${module}", workspace: 'JSxCAD', container: document.getElementById('notebook') });
  </script>
