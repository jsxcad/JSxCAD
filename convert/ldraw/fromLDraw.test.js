        ...
        content: [
          {
            ...
            graph: {
              ...
              faces: [
                {
                  plane: [0, 144, 0, -576],
                  exactPlane: ['0', '144', '0', '-576'],
                },
                {
                  plane: [0, 0, -48, 288],
                  exactPlane: ['0', '0', '-48', '288'],
                },
                { plane: [48, 0, 0, 288], exactPlane: ['48', '0', '0', '288'] },
                { plane: [0, 0, 48, 288], exactPlane: ['0', '0', '48', '288'] },
                {
                  plane: [-48, 0, 0, 288],
                  exactPlane: ['-48', '0', '0', '288'],
                },
                {
                  plane: [0, 80, 0, -640],
                  exactPlane: ['0', '80', '0', '-640'],
                },
                null,
                null,
                null,
                { plane: [0, -400, 0, 0], exactPlane: ['0', '-400', '0', '0'] },
                {
                  plane: [0, 0, 160, -1600],
                  exactPlane: ['0', '0', '160', '-1600'],
                },
                {
                  plane: [-160, 0, 0, -1600],
                  exactPlane: ['-160', '0', '0', '-1600'],
                },
                {
                  plane: [0, 0, -160, -1600],
                  exactPlane: ['0', '0', '-160', '-1600'],
                ...
                {
                  plane: [3.132, 0, 0.20640000000000214, -18.791999999999998],
                  exactPlane: [
                ...
                null,
                {
                  plane: [2.6112, 0, 1.7424, -18.7949952],
                  exactPlane: [
                ...
                null,
                {
                  plane: [1.7424, 0, 2.6112, -18.7949952],
                  exactPlane: [
                    '490441999420647/281474976710656',
                    '0',
                    '734987459186865/281474976710656',
                ...
                null,
                {
                  plane: [0.20640000000000214, 0, 3.132, -18.791999999999998],
                  exactPlane: [
                    '7262054399135/35184372088832',
                    '0',
                    '7052637016462197/2251799813685248',
                ...
                null,
                {
                  plane: [0, -4.6979999999999995, 0, -18.791999999999998],
                  exactPlane: [
                    '0',
