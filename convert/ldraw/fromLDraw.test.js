...
test('Load a file', async (t) => {
  ...
  await write(
    'cache/ldraw/parts/48/1-4cyli.dat',
  ...
  await write(
    'cache/ldraw/parts/48/1-4edge.dat',
        ...
        content: [
          {
            ...
            graph: {
              ...
              exactPoints: [
                ...
                ['2925087957977137/562949953421312', '-4/1', '3/1'],
                ['2925087957977137/562949953421312', '0/1', '3/1'],
                [
                ...
                ['3/1', '-4/1', '2925087957977137/562949953421312'],
                ['3/1', '0/1', '2925087957977137/562949953421312'],
                [
                  '2585291366092033/1125899906842624',
                  '-4/1',
                  '3120656771795701/562949953421312',
              ...
              faces: [
                {
                  plane: [0, 1, 0, -4],
                  exactPlane: ['0/1', '1/1', '0/1', '-4/1'],
                },
                {
                  plane: [0, 0, -1, 6],
                  exactPlane: ['0/1', '0/1', '-1/1', '6/1'],
                },
                {
                  plane: [1, 0, 0, 6],
                  exactPlane: ['1/1', '0/1', '0/1', '6/1'],
                },
                {
                  plane: [0, 0, 1, 6],
                  exactPlane: ['0/1', '0/1', '1/1', '6/1'],
                ...
                {
                  plane: [0, -1, 0, 0],
                  exactPlane: ['0/1', '-1/1', '0/1', '0/1'],
                },
                {
                  plane: [0, 0, 1, -10],
                  exactPlane: ['0/1', '0/1', '1/1', '-10/1'],
                },
                {
                  plane: [-1, 0, 0, -10],
                  exactPlane: ['-1/1', '0/1', '0/1', '-10/1'],
                },
                {
                  plane: [0, 0, -1, -10],
                  exactPlane: ['0/1', '0/1', '-1/1', '-10/1'],
                ...
                },
                {
                  ...
                  exactPlane: [
                    '7052637016462197/7067934734845109',
                    '0/1',
                    '464771481544640/7067934734845109',
                    '-42315822098773182/7067934734845109',
                  ],
                },
                null,
                {
                  ...
                  exactPlane: [
                    '6933741986299615/7069366424102067',
                    '0/1',
                    '1378101485975368/7069366424102067',
                    '-47652277240774499915904151719797/7959398998332891183448282103808',
                  ],
                },
                null,
                {
                  ...
                  exactPlane: [
                    '6695951925974452/7070207122343881',
                    '0/1',
                    '2269814212194728/7070207122343881',
                    '-2978729158015081257564871516483/497521596275314520239567273984',
                  ],
                },
                null,
                {
                  ...
                  exactPlane: [
                    '3169633417743356/3534741051750897',
                    '0/1',
                    '521516836849504/1178247017250299',
                    '-2978436863139682764809408428751/497470577609891713963278729216',
                  ],
                },
                null,
                {
                  ...
                  exactPlane: [
                    '5879899673494920/7068759076195189',
                    '0/1',
                    '3923535995365176/7068759076195189',
                    '-2978185868320836331610788592097/497419699086319761285758058496',
                  ],
                },
                {
                  plane: [
                  ...
                  exactPlane: [
                    '5312446120446232/7069250742809395',
                    '0/1',
                    '4663927774104888/7069250742809395',
                    '-21274363221066883131710370883/3553244978917968010859773952',
                  ],
                },
                null,
                {
                ...
                null,
                {
                  plane: [0, -0.9999999999999999, 0, -3.9999999999999996],
                  exactPlane: [
                    '0/1',
                    '-21157911049386591/21157911049386592',
                    '0/1',
                    '-21157911049386591/5289477762346648',
                  ],
                },
              ],
              facets: [
