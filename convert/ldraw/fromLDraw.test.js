        ...
        content: [
          {
            ...
            graph: {
              ...
              faces: [
                { plane: [0, 1, 0, -4], exactPlane: ['0', '1', '0', '-4'] },
                { plane: [0, 0, -1, 6], exactPlane: ['0', '0', '-1', '6'] },
                {
                  plane: [0.9999999999999998, 0, 0, 5.999999999999999],
                  exactPlane: [
                    '6755399441055744/6755399441055745',
                    '0',
                    '0',
                    '40532396646334464/6755399441055745',
                  ],
                },
                { plane: [0, 0, 1, 6], exactPlane: ['0', '0', '1', '6'] },
                {
                ...
                { plane: [0, 1, 0, -8], exactPlane: ['0', '1', '0', '-8'] },
                null,
                null,
                null,
                { plane: [0, -1, 0, 0], exactPlane: ['0', '-1', '0', '0'] },
                { plane: [0, 0, 1, -10], exactPlane: ['0', '0', '1', '-10'] },
                { plane: [-1, 0, 0, -10], exactPlane: ['-1', '0', '0', '-10'] },
                { plane: [0, 0, -1, -10], exactPlane: ['0', '0', '-1', '-10'] },
                { plane: [1, 0, 0, -10], exactPlane: ['1', '0', '0', '-10'] },
                {
                  plane: [
                  ...
                  exactPlane: [
                    '2350879005487399/2355978244948370',
                    '0',
                    '46477148154464/706793473484511',
                    '-7052637016462197/1177989122474185',
                  ],
                },
                null,
                {
                  ...
                  exactPlane: [
                    '6933741986299615/7069366424102068',
                    '0',
                    '344525371493842/1767341606025517',
                    '-47652277240774499915904151719797/7959398998332892309348188946432',
                  ],
                },
                null,
                {
                  ...
                  exactPlane: [
                    '3347975962987226/3535103561171941',
                    '0',
                    '1134907106097364/3535103561171941',
                    '-2978729158015081257564871516483/497521596275314590608311451648',
                  ],
                },
                null,
                {
                ...
                null,
                {
                  ...
                  exactPlane: [
                    '587989967349492/706875907619519',
                    '0',
                    '53020756694124/95523771299935',
                    '-2978185868320836331610788592097/497419699086319831654502236160',
                  ],
                },
                {
                  plane: [
                  ...
                  exactPlane: [
                    '1328111530111558/1767312685702349',
                    '0',
                    '1165981943526222/1767312685702349',
                    '-43800159572784759388815469465/7315504368360523410134007808',
                  ],
                },
                null,
                {
