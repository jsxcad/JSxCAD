...
![Image](test.md.peg_peg.png)

[peg.stl](test.peg.stl)
...
![Image](test.md.bogey.png)

![Image](test.md.bogey_chassis.png)

[chassis.stl](test.chassis.stl)

![Image](test.md.bogey_wheel.png)

[wheel.stl](test.wheel.stl)

![Image](test.md.bogey_axle.png)

[axle.stl](test.axle.stl)
...
![Image](test.md.t70_t70.png)

[t70.stl](test.t70.stl)

```JavaScript
const t70 = Track(70).stl('t70', getNot('peg'));
```

![Image](test.md.t141_t141.png)

[t141.stl](test.t141.stl)
...
![Image](test.md.j200_j200.png)

[j200.stl](test.j200.stl)
...
![Image](test.md.c100_c100.png)

[c100.stl](test.c100.stl)
...
![Image](test.md.hook2_hook2.png)

[hook2.stl](test.hook2.stl)
...
![Image](test.md.hook_hook.png)

[hook.stl](test.hook.stl)
...
![Image](test.md.jig_jig.png)

[jig.stl](test.jig.stl)

```JavaScript
const jig = Box(15, 5, 5).cut(ArcX(15, 2.3, 2.3)).stl('jig');
```

![Image](test.md.b200_b200a.png)

[b200a.stl](test.b200a.stl)

![Image](test.md.b200_b200b.png)

[b200b.stl](test.b200b.stl)
...
![Image](test.md.c400_c400.png)

[c400.stl](test.c400.stl)

```JavaScript
const c400 = Curve(400).stl('c400', getNot('peg'));
```

![Image](test.md.x70_x70.png)

[x70.stl](test.x70.stl)
...
![Image](test.md.car.png)

![Image](test.md.car_body.png)

[body.stl](test.body.stl)

![Image](test.md.car_wheel.png)
...
![Image](test.md.car26x11.png)

![Image](test.md.car26x11_body.png)

[body.stl](test.body.stl)

![Image](test.md.car26x11_wheel.png)
...
![Image](test.md.hook3_peg_0.5.png)

![Image](test.md.hook3.png)

![Image](test.md.hook3_hook4.png)

[hook4.stl](test.hook4.stl)

![Image](test.md.hook3_bar4.png)

[bar4.stl](test.bar4.stl)

```JavaScript
const hook3 = Group(Arc(5).ez([3]), Arc(3).ez([3, 6]))
  .y(0.5)
  //.maskedBy(grow(Orb(0.5)))
  .and(
    rz(1 / 2)
      .y(8)
      .gap()
...
![Image](test.md.container.png)

![Image](test.md.container_container26.png)

[container26.stl](test.container26.stl)

```JavaScript
const container = As('container', Box(26 - 2.2, 10.5 - 2.2, [5, 18]))
  .join(Box(26 - 2.2, 10.5 - 2.2).Loft(z(18).validate(), offset(1).z(18.5)))
  .join(
    Arc(0.5)
      .ez([5, 18.5])
      .x((26 - 2.2) / 2, (26 - 2.2) / -2)
...
![Image](test.md.c200_c200.png)

[c200.stl](test.c200.stl)
...
![Image](test.md.locomotive.png)

![Image](test.md.locomotive_locomotive_hull.png)

[locomotive_hull.stl](test.locomotive_hull.stl)

![Image](test.md.locomotive_locomotive_tank.png)

[locomotive_tank.stl](test.locomotive_tank.stl)

![Image](test.md.locomotive_locomotive_feet.png)

[locomotive_feet.stl](test.locomotive_feet.stl)
...
![Image](test.md.express.png)

![Image](test.md.express_express_hull.png)

[express_hull.stl](test.express_hull.stl)

![Image](test.md.express_express_feet.png)

[express_feet.stl](test.express_feet.stl)
...
![Image](test.md.j100_j100.png)

[j100.stl](test.j100.stl)
...
![Image](test.md.t35_t35.png)

[t35.stl](test.t35.stl)

```JavaScript
const t35 = Track(35).stl('t35', getNot('peg'));
```

![Image](test.md.y100_y100.png)

[y100.stl](test.y100.stl)
...
![Image](test.md.s100_s100.png)

[s100.stl](test.s100.stl)
...
![Image](test.md.carriage.png)

![Image](test.md.carriage_carriage_hull.png)

[carriage_hull.stl](test.carriage_hull.stl)

![Image](test.md.carriage_carriage_feet.png)

[carriage_feet.stl](test.carriage_feet.stl)
...
![Image](test.md.yy100_yy100.png)

[yy100.stl](test.yy100.stl)
