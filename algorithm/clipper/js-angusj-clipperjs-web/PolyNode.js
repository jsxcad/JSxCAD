...
var PolyNode = /** @class */ (function () {
  ...
  PolyNode.fillFromNativePolyNode = function (
    pn,
    nativeLib,
    nativePolyNode,
    parent,
    ...
    for (var i = 0, max = childs.size(); i < max; i++) {
      var newChild = PolyNode.fromNativePolyNode(
        nativeLib,
        childs.get(i),
        pn,
        i,
    ...
    pn._contour = PathToNativePath_1.nativePathToPath(
      nativeLib,
      nativePolyNode.contour,
      true
    );
  ...
  PolyNode.fromNativePolyNode = function (
    nativeLib,
    nativePolyNode,
    parent,
    childIndex,
