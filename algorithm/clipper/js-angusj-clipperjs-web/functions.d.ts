...
export declare function cleanPolygon(
  nativeLib: NativeClipperLibInstance,
  path: ReadonlyPath,
  distance?: number
): Path;
export declare function cleanPolygons(
  nativeLib: NativeClipperLibInstance,
  paths: ReadonlyPaths,
  distance?: number
): Paths;
export declare function closedPathsFromPolyTree(polyTree: PolyTree): Paths;
export declare function minkowskiDiff(
  nativeLib: NativeClipperLibInstance,
  poly1: ReadonlyPath,
  poly2: ReadonlyPath
): Paths;
export declare function minkowskiSumPath(
  nativeLib: NativeClipperLibInstance,
  pattern: ReadonlyPath,
  path: ReadonlyPath,
  pathIsClosed: boolean
): Paths;
export declare function minkowskiSumPaths(
  nativeLib: NativeClipperLibInstance,
  pattern: ReadonlyPath,
  paths: ReadonlyPaths,
  pathIsClosed: boolean
): Paths;
export declare function openPathsFromPolyTree(
  polyTree: PolyTree
): ReadonlyPath[];
...
export declare function simplifyPolygon(
  nativeLib: NativeClipperLibInstance,
  path: ReadonlyPath,
  fillType?: PolyFillType
): Paths;
export declare function simplifyPolygons(
  nativeLib: NativeClipperLibInstance,
  paths: ReadonlyPaths,
  fillType?: PolyFillType
): Paths;
