...
var ClipperOffset = /** @class */ (function () {
  ...
  function ClipperOffset(_nativeLib, miterLimit, arcTolerance) {
    ...
    this._clipperOffset = new _nativeLib.ClipperOffset(
      miterLimit,
      arcTolerance
    );
  }
  ...
  ClipperOffset.prototype.addPath = function (path, joinType, endType) {
    ...
    try {
      this._clipperOffset.addPath(
        nativePath,
        nativeEnumConversion_1.joinTypeToNative(this._nativeLib, joinType),
        nativeEnumConversion_1.endTypeToNative(this._nativeLib, endType)
      );
    } finally {
      nativePath.delete();
    }
