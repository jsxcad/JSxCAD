...
test('FromPolygonsToSurfaceMesh', (t) => {
  ...
  t.deepEqual(graph, {
    ...
    faces: [
      { loop: 0, surface_mesh: true, plane: [0, 1, 0, 0.5] },
      { loop: 1, surface_mesh: true, plane: [0, 1, 0, 0.5] },
      { loop: 2, surface_mesh: true, plane: [0, 0, -1, -0.5] },
      { loop: 3, surface_mesh: true, plane: [0, 0, 1, 0.5] },
      { loop: 4, surface_mesh: true, plane: [-1, 0, 0, 0.5] },
      { loop: 5, surface_mesh: true, plane: [-1, 0, 0, 0.5] },
      { loop: 6, surface_mesh: true, plane: [0, 0, -1, 0.5] },
      { loop: 7, surface_mesh: true, plane: [0, 0, -1, 0.5] },
      { loop: 8, surface_mesh: true, plane: [1, 0, 0, 0.5] },
      { loop: 9, surface_mesh: true, plane: [1, 0, 0, 0.5] },
      { loop: 10, surface_mesh: true, plane: [0, -1, 0, 0.5] },
      { loop: 11, surface_mesh: true, plane: [0, 1, 0, -0.5] },
    ],
    loops: [
      { edge: 0, face: 0 },
      { edge: 5, face: 1 },
