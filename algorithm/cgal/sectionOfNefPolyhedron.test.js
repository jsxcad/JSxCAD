...
test('Section of tetrahedron.', (t) => {
  ...
  t.deepEqual(JSON.parse(JSON.stringify(graph)), {
    ...
    edges: [
      ...
      { point: 1, next: 15, twin: 12, loop: 5 },
      null,
      { point: 2, next: 9, twin: 10, loop: 8 },
      null,
      { point: 3, next: 11, twin: 8, loop: 3 },
      null,
      { point: 3, next: 11, twin: 8, loop: 6 },
      null,
      { point: 4, next: 16, twin: 17, loop: 8 },
      { point: 2, next: 5, twin: 6, loop: 3 },
      { point: 4, next: 16, twin: 17, loop: 6 },
      { point: 1, next: 3, twin: 4, loop: 8 },
      null,
      { point: 0, next: 7, twin: 0, loop: 6 },
      { point: 5, next: 14, twin: 13, loop: 5 },
    ...
    faces: [
      { plane: [-1, -1, 1, 1], loop: 0 },
      null,
      null,
      { plane: [-1, 1, 1, -1], loop: 3 },
      null,
      { plane: [1, -1, 1, -1], loop: 5 },
      { plane: [1, 1, 1, 1], loop: 6 },
      null,
      { plane: [0, 0, 1, 0], loop: 8 },
    ],
    surfaces: [{ faces: [0, 3, 5, 6, 8] }],
    isClosed: false,
    isOutline: true,
  });
});
