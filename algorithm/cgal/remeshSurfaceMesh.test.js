...
test('RemeshSurfaceMesh', (t) => {
  ...
  t.deepEqual(remeshedGraph, {
    ...
    faces: [
      {
        plane: [0, 0, -0.16666666666666666, -0.08333333333333333],
        exactPlane: [
          '0',
          '0',
      ...
      {
        plane: [0.1111111111111111, 0, 0, -0.05555555555555555],
        exactPlane: [
      ...
      {
        plane: [0, -0.1111111111111111, 0, -0.05555555555555555],
        exactPlane: [
          '0',
          '-288460936585268205588227242619335/2596148429267413814265248164610048',
          '0',
      ...
      {
        plane: [0, 0, 0.1111111111111111, -0.05555555555555555],
        exactPlane: [
          '0',
          '0',
          '288460936585268205588227242619335/2596148429267413814265248164610048',
