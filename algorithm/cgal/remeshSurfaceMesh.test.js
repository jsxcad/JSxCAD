...
test('RemeshSurfaceMesh', (t) => {
  ...
  t.deepEqual(JSON.parse(JSON.stringify(remeshedGraph)), {
    edges: [
      ...
      { point: 8, next: 86, twin: 37, facet: 13, face: 11 },
      { point: 26, next: 231, twin: 36, facet: 76, face: 11 },
      ...
      { point: 9, next: 104, twin: 43, facet: 15, face: 6 },
      { point: 28, next: 239, twin: 42, facet: 79, face: 6 },
      ...
      { point: 10, next: 122, twin: 49, facet: 17, face: 4 },
      { point: 30, next: 273, twin: 48, facet: 89, face: 4 },
      ...
      { point: 11, next: 134, twin: 55, facet: 19, face: 0 },
      { point: 32, next: 261, twin: 54, facet: 81, face: 0 },
      ...
      { point: 12, next: 140, twin: 61, facet: 21, face: 1 },
      { point: 34, next: 275, twin: 60, facet: 91, face: 1 },
      ...
      { point: 13, next: 142, twin: 67, facet: 23, face: 5 },
      { point: 36, next: 245, twin: 66, facet: 73, face: 5 },
      ...
      { point: 27, next: 230, twin: 75, facet: 12, face: 11 },
      { point: 49, next: 153, twin: 74, facet: 24, face: 11 },
      { point: 31, next: 272, twin: 77, facet: 16, face: 4 },
      { point: 45, next: 177, twin: 76, facet: 25, face: 4 },
      { point: 15, next: 278, twin: 79, facet: 52, face: 6 },
      { point: 1, next: 44, twin: 78, facet: 26, face: 11 },
      { point: 49, next: 37, twin: 81, facet: 76, face: 11 },
      { point: 26, next: 45, twin: 80, facet: 40, face: 11 },
      { point: 47, next: 43, twin: 83, facet: 79, face: 6 },
      ...
      { point: 26, next: 254, twin: 87, facet: 13, face: 11 },
      { point: 48, next: 149, twin: 86, facet: 28, face: 11 },
      { point: 35, next: 274, twin: 89, facet: 20, face: 1 },
      ...
      { point: 48, next: 150, twin: 93, facet: 84, face: 11 },
      { point: 27, next: 39, twin: 92, facet: 11, face: 11 },
      { point: 33, next: 260, twin: 95, facet: 18, face: 0 },
      { point: 43, next: 189, twin: 94, facet: 31, face: 0 },
      { point: 18, next: 193, twin: 97, facet: 64, face: 1 },
      { point: 4, next: 164, twin: 96, facet: 9, face: 6 },
      { point: 29, next: 238, twin: 99, facet: 14, face: 6 },
      { point: 47, next: 165, twin: 98, facet: 90, face: 6 },
      { point: 41, next: 61, twin: 101, facet: 91, face: 1 },
      ...
      { point: 28, next: 284, twin: 105, facet: 15, face: 6 },
      { point: 46, next: 161, twin: 104, facet: 34, face: 6 },
      { point: 44, next: 174, twin: 107, facet: 95, face: 4 },
      ...
      { point: 46, next: 162, twin: 111, facet: 94, face: 6 },
      { point: 29, next: 17, twin: 110, facet: 6, face: 6 },
      { point: 38, next: 210, twin: 113, facet: 93, face: 5 },
      ...
      { point: 45, next: 49, twin: 117, facet: 89, face: 4 },
      { point: 30, next: 13, twin: 116, facet: 4, face: 4 },
      { point: 42, next: 186, twin: 119, facet: 86, face: 0 },
      ...
      { point: 30, next: 286, twin: 123, facet: 17, face: 4 },
      { point: 44, next: 173, twin: 122, facet: 82, face: 4 },
      { point: 37, next: 244, twin: 125, facet: 22, face: 5 },
      ...
      { point: 43, next: 55, twin: 129, facet: 81, face: 0 },
      { point: 32, next: 7, twin: 128, facet: 2, face: 0 },
      { point: 40, next: 198, twin: 131, facet: 78, face: 1 },
      { point: 35, next: 5, twin: 130, facet: 1, face: 1 },
      { point: 24, next: 205, twin: 133, facet: 68, face: 5 },
      { point: 7, next: 184, twin: 132, facet: 0, face: 0 },
      { point: 32, next: 268, twin: 135, facet: 19, face: 0 },
      { point: 42, next: 185, twin: 134, facet: 74, face: 0 },
      { point: 39, next: 67, twin: 137, facet: 73, face: 5 },
      ...
      { point: 34, next: 252, twin: 141, facet: 21, face: 1 },
      { point: 40, next: 197, twin: 140, facet: 62, face: 1 },
      { point: 36, next: 276, twin: 143, facet: 23, face: 5 },
      ...
      { point: 26, next: 235, twin: 146, facet: 48, face: 11 },
      { point: 16, next: 243, twin: 149, facet: 50, face: 11 },
      { point: 26, next: 58, twin: 148, facet: 28, face: 11 },
      { point: 27, next: 255, twin: 151, facet: 84, face: 11 },
      { point: 8, next: 74, twin: 150, facet: 12, face: 11 },
      ...
      { point: 28, next: 78, twin: 158, facet: 52, face: 6 },
      { point: 19, next: 279, twin: 161, facet: 8, face: 6 },
      { point: 28, next: 20, twin: 160, facet: 34, face: 6 },
      { point: 29, next: 285, twin: 163, facet: 94, face: 6 },
      { point: 9, next: 98, twin: 162, facet: 14, face: 6 },
      ...
      { point: 30, next: 271, twin: 170, facet: 56, face: 4 },
      { point: 22, next: 265, twin: 173, facet: 47, face: 4 },
      { point: 30, next: 52, twin: 172, facet: 82, face: 4 },
      { point: 31, next: 287, twin: 175, facet: 95, face: 4 },
      { point: 10, next: 76, twin: 174, facet: 16, face: 4 },
      ...
      { point: 32, next: 257, twin: 182, facet: 60, face: 0 },
      { point: 24, next: 249, twin: 185, facet: 0, face: 0 },
      { point: 32, next: 2, twin: 184, facet: 74, face: 0 },
      { point: 33, next: 269, twin: 187, facet: 86, face: 0 },
      { point: 11, next: 94, twin: 186, facet: 18, face: 0 },
      ...
      { point: 4, next: 195, twin: 192, facet: 64, face: 1 },
      { point: 18, next: 101, twin: 195, facet: 61, face: 1 },
      { point: 34, next: 96, twin: 194, facet: 64, face: 1 },
      { point: 25, next: 192, twin: 197, facet: 44, face: 1 },
      { point: 34, next: 46, twin: 196, facet: 62, face: 1 },
      { point: 35, next: 253, twin: 199, facet: 78, face: 1 },
      { point: 12, next: 88, twin: 198, facet: 20, face: 1 },
      ...
      { point: 7, next: 207, twin: 204, facet: 68, face: 5 },
      { point: 24, next: 137, twin: 207, facet: 58, face: 5 },
      { point: 36, next: 132, twin: 206, facet: 68, face: 5 },
      { point: 25, next: 204, twin: 209, facet: 46, face: 5 },
      { point: 36, next: 50, twin: 208, facet: 66, face: 5 },
      { point: 37, next: 277, twin: 211, facet: 93, face: 5 },
      { point: 13, next: 124, twin: 210, facet: 22, face: 5 },
      ...
      { point: 49, next: 151, twin: 231, facet: 12, face: 11 },
      { point: 8, next: 80, twin: 230, facet: 76, face: 11 },
      ...
      { point: 15, next: 242, twin: 234, facet: 48, face: 11 },
      { point: 49, next: 79, twin: 237, facet: 26, face: 11 },
      { point: 1, next: 71, twin: 236, facet: 72, face: 11 },
      { point: 47, next: 163, twin: 239, facet: 14, face: 6 },
      { point: 9, next: 82, twin: 238, facet: 79, face: 6 },
      { point: 25, next: 145, twin: 241, facet: 69, face: 5 },
      { point: 4, next: 196, twin: 240, facet: 44, face: 1 },
      { point: 2, next: 147, twin: 243, facet: 48, face: 11 },
      { point: 26, next: 85, twin: 242, facet: 50, face: 11 },
      { point: 39, next: 211, twin: 245, facet: 22, face: 5 },
      { point: 13, next: 136, twin: 244, facet: 73, face: 5 },
      { point: 3, next: 200, twin: 247, facet: 53, face: 1 },
      { point: 16, next: 233, twin: 246, facet: 80, face: 11 },
      { point: 7, next: 183, twin: 249, facet: 60, face: 0 },
      ...
      { point: 40, next: 60, twin: 253, facet: 21, face: 1 },
      { point: 12, next: 130, twin: 252, facet: 78, face: 1 },
      { point: 48, next: 36, twin: 255, facet: 13, face: 11 },
      { point: 8, next: 92, twin: 254, facet: 84, face: 11 },
      { point: 7, next: 4, twin: 257, facet: 43, face: 1 },
      { point: 23, next: 248, twin: 256, facet: 60, face: 0 },
      { point: 0, next: 188, twin: 259, facet: 10, face: 0 },
      { point: 17, next: 218, twin: 258, facet: 51, face: 11 },
      { point: 43, next: 187, twin: 261, facet: 18, face: 0 },
      { point: 11, next: 128, twin: 260, facet: 81, face: 0 },
      { point: 0, next: 191, twin: 263, facet: 63, face: 0 },
      { point: 33, next: 258, twin: 262, facet: 10, face: 0 },
      { point: 6, next: 171, twin: 265, facet: 56, face: 4 },
      ...
      { point: 42, next: 54, twin: 269, facet: 19, face: 0 },
      { point: 11, next: 118, twin: 268, facet: 86, face: 0 },
      { point: 6, next: 8, twin: 271, facet: 39, face: 0 },
      { point: 21, next: 264, twin: 270, facet: 56, face: 4 },
      { point: 45, next: 175, twin: 273, facet: 16, face: 4 },
      { point: 10, next: 116, twin: 272, facet: 89, face: 4 },
      { point: 41, next: 199, twin: 275, facet: 20, face: 1 },
      { point: 12, next: 100, twin: 274, facet: 91, face: 1 },
      { point: 38, next: 66, twin: 277, facet: 23, face: 5 },
      { point: 13, next: 112, twin: 276, facet: 93, face: 5 },
      { point: 1, next: 159, twin: 279, facet: 52, face: 6 },
      ...
      { point: 46, next: 42, twin: 285, facet: 15, face: 6 },
      { point: 9, next: 110, twin: 284, facet: 94, face: 6 },
      { point: 44, next: 48, twin: 287, facet: 17, face: 4 },
      { point: 10, next: 106, twin: 286, facet: 95, face: 4 },
    ],
    points: [
      [-0.5, 0.5, -0.5],
      [-0.5, 0.5, 0.5],
    ...
    faces: [
      {
        plane: [0, 0, -1, -0.08333333333333333],
        exactPlane: [
          '0',
          '0',
          '-24019198012642645/144115188075855872',
          '-24019198012642645/288230376151711744',
        ],
      },
      {
        plane: [1, 0, 0, -0.05555555555555555],
        exactPlane: [
          '288460936585268205588227242619335/2596148429267413814265248164610048',
          '0',
          '0',
          '-288460936585268205588227242619335/5192296858534827628530496329220096',
        ],
      },
      null,
      null,
      ...
      {
        plane: [0, -1, 0, -0.05555555555555555],
        exactPlane: [
          '0',
          '-288460936585268205588227242619335/2596148429267413814265248164610048',
          '0',
      ...
      {
        plane: [0, 0, 1, -0.05555555555555555],
        exactPlane: [
          '0',
          '0',
          '288460936585268205588227242619335/2596148429267413814265248164610048',
