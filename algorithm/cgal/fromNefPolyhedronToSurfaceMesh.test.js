...
test('fromNefPolyhedronToSurfaceMesh', (t) => {
  ...
  t.deepEqual(reconstitutedGraph, {
    edges: [
      ...
      { point: 3, next: 4, loop: 0, twin: 3 },
      { point: 0, next: 8, loop: 1, twin: 2 },
      { point: 2, next: 6, loop: 0, twin: 5 },
      { point: 3, next: 13, loop: 4, twin: 4 },
      { point: 1, next: 0, loop: 0, twin: 7 },
      { point: 2, next: 18, loop: 3, twin: 6 },
      { point: 5, next: 10, loop: 1, twin: 9 },
      { point: 0, next: 1, loop: 2, twin: 8 },
      { point: 4, next: 12, loop: 1, twin: 11 },
      { point: 5, next: 17, loop: 5, twin: 10 },
      { point: 3, next: 3, loop: 1, twin: 13 },
      { point: 4, next: 22, loop: 4, twin: 12 },
      { point: 6, next: 16, loop: 2, twin: 15 },
      { point: 1, next: 7, loop: 3, twin: 14 },
      { point: 5, next: 9, loop: 2, twin: 17 },
      { point: 6, next: 21, loop: 5, twin: 16 },
      { point: 7, next: 20, loop: 3, twin: 19 },
      { point: 2, next: 5, loop: 4, twin: 18 },
      { point: 6, next: 15, loop: 3, twin: 21 },
      { point: 7, next: 23, loop: 5, twin: 20 },
      { point: 7, next: 19, loop: 4, twin: 23 },
      { point: 4, next: 11, loop: 5, twin: 22 },
    ],
    faces: [
