...
test('Difference of box and tetrahedron.', (t) => {
  ...
  t.deepEqual(JSON.parse(JSON.stringify(graph)), {
    ...
    faces: [
      ...
      { plane: [-1, 0, 0, -0.5], loop: 8, points_plane: [-1, 0, 0, 0.5] },
      { plane: [0, 0, -1, -0.5], loop: 9, points_plane: [0, 0, -1, 0.5] },
      { plane: [0, -1, 0, -0.5], loop: 10, points_plane: [0, -1, 0, 0.5] },
      { plane: [0, 0, 1, -0.5], loop: 11, points_plane: [0, 0, 1, 0.5] },
      { plane: [-1, 0, 0, -0.5], loop: 12, points_plane: [-1, 0, 0, 0.5] },
      { plane: [0, 1, 0, -0.5], loop: 13, points_plane: [0, 1, 0, 0.5] },
      { plane: [1, 0, 0, -0.5], loop: 14, points_plane: [1, 0, 0, 0.5] },
      { plane: [0, -1, 0, -0.5], loop: 15, points_plane: [0, -1, 0, 0.5] },
      { plane: [0, 0, 1, -0.5], loop: 16, points_plane: [0, 0, 1, 0.5] },
      { plane: [0, 1, 0, -0.5], loop: 17, points_plane: [0, 1, 0, 0.5] },
      { plane: [0, 0, -1, -0.5], loop: 18, points_plane: [0, 0, -1, 0.5] },
      { plane: [1, 0, 0, -0.5], loop: 19, points_plane: [1, 0, 0, 0.5] },
    ],
    volumes: [
      {
