...
test('Section of tetrahedron.', (t) => {
  ...
  t.deepEqual(JSON.parse(JSON.stringify(graphs)), [
    {
      edges: [
        { point: 0, next: 8, twin: 1, facet: 0, face: 0 },
        { point: 1, next: 7, twin: 0, facet: -1, face: -1 },
        { point: 1, next: 4, twin: 3, facet: 1, face: 0 },
        { point: 2, next: 1, twin: 2, facet: -1, face: -1 },
        { point: 2, next: 9, twin: 5, facet: 1, face: 0 },
        { point: 3, next: 3, twin: 4, facet: -1, face: -1 },
        { point: 3, next: 0, twin: 7, facet: 0, face: 0 },
        { point: 0, next: 5, twin: 6, facet: -1, face: -1 },
        { point: 1, next: 6, twin: 9, facet: 0, face: 0 },
        { point: 3, next: 2, twin: 8, facet: 1, face: 0 },
      ],
      points: [
        [1, 0, 0],
        [0, 1, 0],
