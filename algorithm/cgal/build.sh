...
# -g does supply debugging info, but makes the wasm 200 meg
# emcc -g -DCGAL_HAS_NO_INTERVAL_SUPPORT -DCGAL_DISABLE_ROUNDING_MATH_CHECK -DCGAL_EIGEN3_ENABLED -DCGAL_DO_NOT_USE_BOOST_MP -DCGAL_DONT_USE_LAZY_KERNEL -DCGAL_NO_STATIC_FILTERS cgal.cc -I . -I ~/opt/include -L ~/opt/lib -static -O3 -std=c++1z --bind -o cgal.cjs -lmpfr -lgmp -s MODULARIZE=1 -s USE_ES6_IMPORT_META=0 -s USE_BOOST_HEADERS=1 -s ALLOW_MEMORY_GROWTH=1 -s ASSERTIONS=1 -s DISABLE_EXCEPTION_CATCHING=2 && mv cgal.js cgal.cjs
