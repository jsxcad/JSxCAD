...
test('fromNefPolyhedronToGraph', (t) => {
  ...
  t.deepEqual(JSON.parse(JSON.stringify(outputGraph)), {
    ...
    edges: [
      ...
      { point: 2, next: 5, twin: 6, loop: 0 },
      { point: 1, next: 17, twin: 18, loop: 1 },
      { point: 3, next: 0, twin: 7, loop: 0 },
      { point: 2, next: 21, twin: 16, loop: 4 },
      { point: 3, next: 27, twin: 28, loop: 3 },
      { point: 4, next: 9, twin: 10, loop: 0 },
      { point: 5, next: 11, twin: 12, loop: 0 },
      { point: 4, next: 32, twin: 33, loop: 5 },
      { point: 6, next: 13, twin: 14, loop: 0 },
      { point: 5, next: 37, twin: 36, loop: 8 },
      { point: 7, next: 8, twin: 15, loop: 0 },
      { point: 6, next: 42, twin: 45, loop: 7 },
      { point: 7, next: 38, twin: 39, loop: 6 },
      { point: 2, next: 4, twin: 3, loop: 1 },
      { point: 8, next: 19, twin: 20, loop: 1 },
      { point: 1, next: 2, twin: 1, loop: 2 },
      { point: 9, next: 16, twin: 21, loop: 1 },
      { point: 8, next: 25, twin: 22, loop: 9 },
      { point: 9, next: 30, twin: 31, loop: 4 },
      { point: 8, next: 18, twin: 17, loop: 2 },
      { point: 10, next: 22, twin: 25, loop: 2 },
      { point: 0, next: 7, twin: 0, loop: 3 },
      { point: 10, next: 29, twin: 26, loop: 9 },
      { point: 10, next: 24, twin: 23, loop: 3 },
      { point: 11, next: 26, twin: 29, loop: 3 },
      { point: 3, next: 6, twin: 5, loop: 4 },
      { point: 11, next: 31, twin: 30, loop: 9 },
      { point: 11, next: 28, twin: 27, loop: 4 },
      { point: 9, next: 20, twin: 19, loop: 9 },
      { point: 12, next: 34, twin: 35, loop: 5 },
      { point: 4, next: 15, twin: 8, loop: 6 },
      { point: 13, next: 36, twin: 37, loop: 5 },
      { point: 12, next: 41, twin: 40, loop: 9 },
      { point: 5, next: 10, twin: 9, loop: 5 },
      { point: 13, next: 46, twin: 47, loop: 8 },
      { point: 14, next: 40, twin: 41, loop: 6 },
      { point: 7, next: 14, twin: 13, loop: 7 },
      { point: 12, next: 33, twin: 32, loop: 6 },
      { point: 14, next: 44, twin: 43, loop: 9 },
      { point: 15, next: 43, twin: 44, loop: 7 },
      { point: 14, next: 39, twin: 38, loop: 7 },
      { point: 15, next: 47, twin: 46, loop: 9 },
      { point: 6, next: 12, twin: 11, loop: 8 },
      { point: 15, next: 45, twin: 42, loop: 8 },
      { point: 13, next: 35, twin: 34, loop: 9 },
    ],
    loops: [
      { edge: 0, face: 0 },
      { edge: 8, face: 0 },
