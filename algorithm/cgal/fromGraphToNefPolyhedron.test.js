...
test('FromGraphToSurfaceMesh', (t) => {
  ...
  t.deepEqual(regeneratedGraph, {
    ...
    edges: [
      ...
      { point: 0, next: 14, twin: 15, loop: 2 },
      { point: 2, next: 5, twin: 6, loop: 0 },
      { point: 1, next: 8, twin: 9, loop: 1 },
      { point: 3, next: 0, twin: 7, loop: 0 },
      { point: 2, next: 13, twin: 12, loop: 4 },
      { point: 3, next: 18, twin: 19, loop: 3 },
      { point: 4, next: 10, twin: 11, loop: 1 },
      { point: 1, next: 2, twin: 1, loop: 2 },
      { point: 5, next: 12, twin: 13, loop: 1 },
      { point: 4, next: 17, twin: 16, loop: 5 },
      { point: 2, next: 4, twin: 3, loop: 1 },
      { point: 5, next: 22, twin: 23, loop: 4 },
      { point: 6, next: 16, twin: 17, loop: 2 },
      { point: 0, next: 7, twin: 0, loop: 3 },
      { point: 4, next: 9, twin: 8, loop: 2 },
      { point: 6, next: 21, twin: 20, loop: 5 },
      { point: 7, next: 20, twin: 21, loop: 3 },
      { point: 3, next: 6, twin: 5, loop: 4 },
      { point: 6, next: 15, twin: 14, loop: 3 },
      { point: 7, next: 23, twin: 22, loop: 5 },
      { point: 7, next: 19, twin: 18, loop: 4 },
      { point: 5, next: 11, twin: 10, loop: 5 },
    ],
    loops: [
      { edge: 0, face: 0 },
      { edge: 4, face: 1 },
