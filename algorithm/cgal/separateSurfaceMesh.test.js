...
import { separateSurfaceMesh } from './separateSurfaceMesh.js';
...
test('Split', (t) => {
  ...
  const separateMeshes = separateSurfaceMesh(a);
  const graphs = separateMeshes.map((separateMesh) =>
    fromSurfaceMeshToGraph(separateMesh)
  );
