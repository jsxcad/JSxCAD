...
test('Slice a cube to form a square.', t => {
  ...
  t.deepEqual(polygons,
              [[[0, -0.5, 0], [0.5, -0.5, 0], [0.5, 0, 0], [0.5, 0.5, 0], [0, 0.5, 0], [-0.5, 0.5, 0], [-0.5, 0, 0],
                [-0.5, -0.5, 0]]]);
});
...
test('Slice a sphere to form a circle.', t => {
  ...
  const polygons = cutTrianglesByPlane(fromPoints([0, 0, 0], [1, 0, 0], [0, 1, 0]), input);
  t.deepEqual(polygons,
              [[[0.52573, -0.85065, -0], [0.85065, 0, 0], [0.52573, 0.85065, 0], [-0.52573, 0.85065, 0],
                [-0.85065, 0, 0], [-0.52573, -0.85065, -0]]]);
});
