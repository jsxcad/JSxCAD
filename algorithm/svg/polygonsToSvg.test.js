...
test('Triangle', t => {
  ...
  t.is(svg,
       ['<?xml version="1.0" encoding="UTF-8"?>',
        ...
        '<svg baseProfile="tiny" height="0.86603 mm" width="1 mm" viewBox="-2 -2 5 4.86603" version="1.1" stroke="black" stroke-width=".1" fill="none" xmlns="http://www.w3.org/2000/svg">',
...
test('Octagon', t => {
  ...
  t.is(svg,
       ['<?xml version="1.0" encoding="UTF-8"?>',
        '<!-- Generated by jsxcad -->',
        '<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1 Tiny//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11-tiny.dtd">',
        '<svg baseProfile="tiny" height="1 mm" width="1 mm" viewBox="-2 -2 5 5" version="1.1" stroke="black" stroke-width=".1" fill="none" xmlns="http://www.w3.org/2000/svg">',
