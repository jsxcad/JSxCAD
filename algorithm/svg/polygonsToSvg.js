...
export const polygonsToSvg = (options = {}, rawPolygons) => {
  ...
  return [
    ...
    `<svg baseProfile="tiny" height="${height} mm" width="${width} mm" viewBox="-2 -2 ${width+4} ${height+4}" version="1.1" stroke="black" stroke-width=".1" fill="none" xmlns="http://www.w3.org/2000/svg">`,
