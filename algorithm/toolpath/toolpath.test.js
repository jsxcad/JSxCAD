...
test('paths', (t) => {
  ...
  t.deepEqual(canonicalize(cuts), [
    [null, [1, 0, 0], [-0.5, 0.86603, 0]],
    [null, [-0.5, 0.86603, 0], [-0.5, -0.86603, 0]],
    [null, [-0.5, -0.86603, 0], [1, 0, 0]],
    [null, [1, 0, 0], [-0.5, 0.86603, 0]],
  ]);
});
...
test('radius = 1', (t) => {
  ...
  t.deepEqual(canonicalize(cuts), [
    [null, [0.63398, 1.36603, 0], [0.86603, 1.23205, 0]],
    [null, [-1.5, -0.13397, 0], [-1.5, 0.13397, 0]],
    [null, [0.86603, -1.23205, 0], [0.63398, -1.36603, 0]],
    [null, [0.63398, 1.36603, 0], [0.86603, 1.23205, 0]],
  ]);
});
