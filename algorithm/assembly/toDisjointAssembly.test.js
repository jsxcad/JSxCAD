...
test('Simple', t => {
  ...
  writeFileSync('toDisjointAssembly.test.simple.0.pdf', pathsToPdf({}, disjoint.assembly[0].z0Surface));
  t.deepEqual(canonicalize(disjoint.assembly[0].z0Surface),
              [[[0, 1, 0], [-0.86603, -0.5, 0], [0.86603, -0.5, 0]]]);

  writeFileSync('toDisjointAssembly.test.simple.1.pdf', pathsToPdf({}, disjoint.assembly[1].z0Surface));
  ...
  writeFileSync('toDisjointAssembly.test.simple.2.pdf', pathsToPdf({}, disjoint.assembly[2].z0Surface));
