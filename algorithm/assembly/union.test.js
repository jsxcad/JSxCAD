...
import { scale as scaleSolid, fromPolygons as solidFromPolygons, translate as translateSolid } from '@jsxcad/algorithm-solid';
...
test('Surface', t => {
  ...
  writeFileSync('union.test.surface.pdf', toPdf({}, unioned));
...
test('Solid', t => {
  ...
  writeFileSync('union.test.solid.stl', toStla({}, unioned));
  t.deepEqual(canonicalize(unioned),
