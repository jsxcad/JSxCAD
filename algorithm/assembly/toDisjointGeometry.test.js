...
test('Simple', t => {
  ...
  writeFileSync('toDisjointGeometry.test.simple.0.pdf', toPdf({}, disjoint.assembly[0].z0Surface));
  t.deepEqual(canonicalize(disjoint.assembly[0].z0Surface),
              [[[0, 1, 0], [-0.86603, -0.5, 0], [0.86603, -0.5, 0]]]);

  writeFileSync('toDisjointGeometry.test.simple.1.pdf', toPdf({}, disjoint.assembly[1].z0Surface));
  ...
  writeFileSync('toDisjointGeometry.test.simple.2.pdf', toPdf({}, disjoint.assembly[2].z0Surface));
