...
test('Overlapping intersection', t => {
  const intersected = intersection(transform(fromTranslation([0.5, 0.5, 0.5]), fromPolygons({}, cubePolygons)),
                                   fromPolygons({}, cubePolygons));
  t.deepEqual(toGeneric(intersected),
              [[[[-0.5, 1, 1], [-0.5, 1, -0.5], [-0.5, -0.5, -0.5], [-0.5, -0.5, 1]]], [[[1, -0.5, 1], [-0.5, -0.5, 1], [-0.5, -0.5, -0.5], [1, -0.5, -0.5]]], [[[1, 1, -0.5], [1, -0.5, -0.5], [-0.5, -0.5, -0.5], [-0.5, 1, -0.5]]], [[[1, 1, -0.5], [1, 1, 1], [1, -0.5, 1], [1, -0.5, -0.5]]], [[[1, 1, 1], [1, 1, -0.5], [-0.5, 1, -0.5], [-0.5, 1, 1]]], [[[1, -0.5, 1], [1, 1, 1], [-0.5, 1, 1], [-0.5, -0.5, 1]]]]);
});
