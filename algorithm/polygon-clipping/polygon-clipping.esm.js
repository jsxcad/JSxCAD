...
var getBboxOverlap = function getBboxOverlap(b1, b2) {
  ...
  if (
    ...
    return null; // find the middle two X values
      ...
      [
        ...
        },
        {
          ...
          value: function getIntersection(other) {
            ...
            var touchesThisRSE =
              isInBbox(oBbox, trp) && other.comparePoint(trp) === 0; // do left endpoints match?
        ...
        },
        {
          ...
          value: function split(point) {
            ...
            if (
              SweepEvent.comparePoints(
                newSeg.leftSE.point,
                newSeg.rightSE.point
              ) > 0
            ) {
              newSeg.swapEvents();
            }
            ...
            if (
              SweepEvent.comparePoints(this.leftSE.point, this.rightSE.point) >
              0
            ) {
              this.swapEvents();
          ...
          value: function isInResult() {
            ...
            switch (operation.type) {
              ...
              case 'intersection': {
                ...
                this._isInResult =
                  most === operation.numMultiPolys && least < most;
                break;
              }
              ...
              default:
                throw new Error(
                  'Unrecognized operation type found '.concat(operation.type)
                );
            }
      ...
      },
      {
        ...
        value: function isExteriorRing() {
          if (this._isExteriorRing === undefined) {
            ...
            this._isExteriorRing = enclosing
              ? !enclosing.isExteriorRing()
              : true;
          }
          ...
          if (!node)
            throw new Error(
              'Unable to find segment #'.concat(segment.id, ' ') +
                '['
                  .concat(segment.leftSE.point.x, ', ')
                  .concat(segment.leftSE.point.y, '] -> ') +
                '['
                  .concat(segment.rightSE.point.x, ', ')
                  .concat(segment.rightSE.point.y, '] ') +
          ...
          if (event.isLeft) {
            ...
            if (prevSeg) {
              ...
              if (prevInter !== null) {
                ...
                if (!prevSeg.isAnEndpoint(prevInter)) {
                  var newEventsFromSplit = this._splitSafely(
                    prevSeg,
                    prevInter
                  );

                  for (
                    var i = 0, iMax = newEventsFromSplit.length;
                    i < iMax;
                    i++
                  ) {
            ...
            if (nextSeg) {
              ...
              if (nextInter !== null) {
                ...
                if (!nextSeg.isAnEndpoint(nextInter)) {
                  var _newEventsFromSplit = this._splitSafely(
                    nextSeg,
                    nextInter
                  );

                  for (
                    var _i = 0, _iMax = _newEventsFromSplit.length;
                    _i < _iMax;
                    _i++
                  ) {
            ...
            if (prevMySplitter !== null || nextMySplitter !== null) {
              ...
              if (prevMySplitter === null) mySplitter = nextMySplitter;
                ...
                mySplitter =
                  cmpSplitters <= 0 ? prevMySplitter : nextMySplitter;
              ...
              for (
                var _i2 = 0, _iMax2 = _newEventsFromSplit2.length;
                _i2 < _iMax2;
                _i2++
              ) {
            ...
            if (prevSeg && nextSeg) {
              ...
              if (inter !== null) {
                if (!prevSeg.isAnEndpoint(inter)) {
                  ...
                  for (
                    var _i3 = 0, _iMax3 = _newEventsFromSplit3.length;
                    _i3 < _iMax3;
                    _i3++
                  ) {
                ...
                if (!nextSeg.isAnEndpoint(inter)) {
                  ...
                  for (
                    var _i4 = 0, _iMax4 = _newEventsFromSplit4.length;
                    _i4 < _iMax4;
                    _i4++
                  ) {
        ...
        value: function run(type, geom, moreGeoms) {
          ...
          if (operation.type === 'difference') {
            ...
            while (_i3 < multipolys.length) {
              if (getBboxOverlap(multipolys[_i3].bbox, subject.bbox) !== null)
                _i3++;
              else multipolys.splice(_i3, 1);
            }
          }
              ...
              throw new Error(
                'Unable to pop() '.concat(
                  ...
                  '['
                    ...
                    .concat(seg.id, ' ') +
                  '['
                    .concat(seg.leftSE.point.x, ', ')
                    .concat(seg.leftSE.point.y, '] -> ') +
                  '['
