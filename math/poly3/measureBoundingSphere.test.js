...
test('poly3: bounding sphere of triangle', (t) => {
  t.deepEqual(measureBoundingSphere(triangle), [fromValuesAVec3(0, 5, 5), 7.0710678118654755]);
});

test('poly3: bounding sphere of square', (t) => {
  t.deepEqual(measureBoundingSphere(square), [fromValuesAVec3(0, 5, 5), 7.0710678118654755]);
});
...
test('poly3: bounding sphere of rotated empty', (t) => {
  t.deepEqual(measureBoundingSphere(transform(rotation, empty)), [fromValuesAVec3(0, 0, 0), 0]);
});
