...
test('Wood Screw with Finish', t => {
  const designator = decode('#10 x 1 Slotted Round Head Wood Screw, Zinc Plated');
  t.deepEqual(designator,
              {
                fastenerName: 'wood screw',
                headType: 'round head',
...
test('Wood Screw with Material and Finish', t => {
  const designator = decode('#10 x 1 Slotted Round Head Wood Screw, Brass Zinc Plated');
  t.deepEqual(designator,
              {
                fastenerName: 'wood screw',
                headType: 'round head',
