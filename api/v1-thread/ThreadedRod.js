import { Cube, Cylinder, Triangle } from "@jsxcad/api-v1-shapes";
import { assemble, intersection } from "@jsxcad/api-v1-shape";
...
const ofRadius = ({
  ...
  if (bore) {
    return assemble(bore().drop(), rod.nocut());
  } else {
    return rod;
  }
};
