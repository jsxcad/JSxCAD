...
export const toolpath = (shape, radius = 1, { overcut = 0, joinPaths = false } = {}) =>
  Shape.fromGeometry({ paths: overcutAlgorithm(shape.outline().toKeptGeometry(), radius, overcut, joinPaths) });
