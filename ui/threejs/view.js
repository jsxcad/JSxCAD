...
export const staticView = async (shape, { target, position, up = [0, 0, 1], width = 256, height = 128 } = {}) => {
...
export const orbitView = async (shape, { target, position, up = [0, 0, 1], width = 256, height = 128 } = {}) => {
